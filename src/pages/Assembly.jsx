...
const assemblyGroups = [
  { id: 1, label: "1 – 10", start: 1, end: 10 },
  { id: 2, label: "10 – 20", start: 10, end: 20 },
  { id: 3, label: "20 – 30", start: 20, end: 30 },
  { id: 4, label: "30 – 40", start: 30, end: 40 },
   { id: 5, label: "40 – 50", start: 40, end: 50 },
    { id: 6, label: "50 – 60", start: 50, end: 60 },
     { id: 7, label: "60 – 70", start: 60, end: 70 },
      { id: 8, label: "70 – 80", start: 70, end: 80 },
       { id: 9, label: "80 – 90", start: 80, end: 90 },
        { id: 10, label: "90 – 100", start: 90, end: 100 },
